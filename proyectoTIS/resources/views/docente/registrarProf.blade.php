...
<div class="container-fluid">                       
    ...
    <form role="form">
      ...
      <div class="form-group">
        ...
        <input class="form-control" placeholder="Carga horaria del docente">
      </div>
      <div class="form-group">
        <label>Telefono</label>
        <input class="form-control" placeholder="Telefono del docente">
      </div>
      <div class="form-group">
        <label>Direccion</label>
        <input class="form-control" placeholder="Direccion del docente">
      </div>
      <div class="form-group">
